...
public interface IStatusService
{
    ...
    Task<string> UpdateStatusAsync(UpdateStatusDto updateStatus, CancellationToken cancellationToken = default(CancellationToken));
    Task<string> DeleteStatusAsync(string id, CancellationToken cancellationToken = default(CancellationToken));
